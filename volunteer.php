    ...
    <div class="container">
        <div class="row mt-100">
                ...
                <div class="row" id="volunteer_row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-20">
                        <div class="volunteer-card shadow">
                            ...
                            <img src="https://simpleisbetterthancomplex.com/img/picture.jpg" alt="" class="img-fluid">
                            <div class="info flex-column">
                                <h6>Aashir Hussain</h6>
                                <div class="d-flex justify-content-around align-items-center">
                                    <a href="https://www.facebook.com/newhoperelief" class="mr-10"><svg
            ...
            <div class="col-lg-4 pt-50 pb-50 pr-50 pl-50 d-flex justify-content-center flex-column"
                style="background-color:#0071a9; color:white;min-height:300px;max-height:500px">
                <div class="contact-info">

                    <div class="media-body">

                        <h5 class="text-white d-flex flex-row align-items-center"> Become A Volunteer</h5>
                        <p>We regularly publish selected volunteer opportunities. You must first create your profile in
                            the NewhopeRelief to apply. Some assignments are not published because they are
                            filled by candidates whose profiles are matched directly from our Global Talent Pool. Some
                            sponsored assignments may have additional eligibility criteria, which you will find in the
                            PDF file linked to the special call.</p>

                        <hr class="light">
                        <button class="btn btn-primary px-10 py-10">Become a volunteer</button>
                    </div>
                </div>
