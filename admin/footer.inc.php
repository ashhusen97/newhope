...
$(document).ready(function() {
    ...
    $('ul li').click(function(e) {
        ...
        window.location.href = link + "?no=" + no
    });
    ...
    $('.change-img-container').fadeOut();
    $('.change-vid-container').fadeOut();
    $('.change-img').click(
        function() {
            $('.change-img-container').fadeIn();
        })

    $('.change-video').click(function() {
        $('.change-vid-container').fadeIn();
    })
