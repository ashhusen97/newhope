            ...
            <div class="container-fluids">
                <div class="row m-0 p-0">
                    <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <a href="tel:(+44)-7599369656"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        ...
                        <a href="mailto: info@newhoperelief.org">
                            ...
                            </svg> info@newhoperelief.org
                        </a>
                    </div>
                    <!-- <div class="col-lg-4 col-md-6">
                        
                    </div> -->
                    <div class="col-lg-6 col-md-6 col-12 col-sm-6 mt-20 mt-lg-0 mt-md-0">
                        <div class=" float-lg-right float-md-right">
                            <a href="#" class="mt-10 mt-lg-0 mt-md-0">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                ...
                                </svg> Account No : 33318214 <span style="color:cornsilk">|</span> S/C : 20-55-41 <span
                                    style="color:cornsilk">|</span> BARCLAYS BANK
                            </a>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-2 hidden-lg">
                        <button class="navbar-toggler collapsed" type="button" data-toggle="collapse"
                            data-target=".main-menu-collapse" aria-expanded="false" aria-label="Toggle navigation">
                            <span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span>
                        </button>
                    </div>
                    <div class="col-4 col-lg-2 order-lg-2 ">
                        <a class="navbar-brand" href="#" style=" width:250px !important">
                            <img src="./images/logo1_.png" alt="" class="my-2" style="width: 100%;" />
                        </a>
                    </div>
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item drop-down">
                                ...
                                <div class="drop-down-content">
                                    ...
                                    <a class="dropdown-item" href="#">Transparency</a>
